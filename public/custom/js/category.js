$(document).ready(function () {
    ...
    $('#form_submit').submit(function (e) {
        ...
        let  my_url = base + "/category-store";
        $.ajax({
            type: 'post',
            url: my_url,
            data: formData,
...
function Status(id) {
    ...
    let  my_url = base + "/category-status/" + id;
    $.ajax({
        type: 'get',
        url: my_url,
        success: (data) => {
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                let  my_url = base + "/category-delete/" + id;
                $.ajax({
                    type: 'delete',
                    url: my_url,
                    success: (data) => {
...
function Show(id) {
    ...
    let  my_url = base + "/category-show/" + id;
    $.ajax({
        type: 'get',
        url: my_url,
        success: (data) => {
            ...
            $('#previewImg').attr('src', '/storage/category/'+data.data.photo);
