    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-xl-3">
                <div class="footer-widget"><a class="footer-logo" href="#"><img src="{{asset('frontend/images/logo.png')}}" alt="logo"></a>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="footer-widget contact"><h3 class="footer-title">contact us</h3>
                    <ul class="footer-contact">
                        <li><i class="icofont-ui-email"></i>
                            <p><span>support@greeny.com</span><span>carrer@greeny.com</span></p></li>
                        <li><i class="icofont-ui-touch-phone"></i>
                            <p><span>+120 279 532 13</span><span>+120 279 532 14</span></p></li>
                        <li><i class="icofont-location-pin"></i>
                            <p>1Hd- 50, 010 Avenue, NY 90001 United States</p></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="footer-widget"><h3 class="footer-title">Download App</h3>
                    ...
                    <div class="footer-app"><a href="#"><img src="{{asset('frontend/images/google-store.png')}}" alt="google"></a><a href="#"><img
                                src="{{asset('frontend/images/app-store.png')}}" alt="app"></a></div>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="footer-bottom"><p class="footer-copytext">&copy; All Copyrights Reserved by <a
                    ...
                    <div class="footer-card"><a href="#"><img src="{{asset('frontend/images/payment/jpg/01.jpg')}}" alt="payment"></a><a
                            href="#"><img src="{{asset('frontend/images/payment/jpg/02.jpg')}}" alt="payment"></a><a href="#"><img
                                ...
                                src="{{asset('frontend/images/payment/jpg/04.jpg')}}" alt="payment"></a></div>
                </div>
            </div>
        </div>
    </div>
