...
<header class="header-part">
    <div class="container">
        <div class="header-content">
            ...
            <a href="{{url('/')}}" class="header-logo"><img src="{{asset('frontend/images/logo.png')}}"
                                                            alt="logo"></a><a href="{{url('login')}}"
                                                                              class="header-widget"
                                                                              title="My Account"><img
                    src="{{asset('frontend/images/user.png')}}" alt="user"><span>join</span></a>
            <form class="header-form"><input type="text" placeholder="Search anything...">
                <button><i class="fas fa-search"></i></button>
            </form>
            <div class="header-widget-group"><a href="#" class="header-widget" title="Compare List"><i
                        class="fas fa-random"></i><sup>0</sup></a><a href="#" class="header-widget"
                                                                     title="Wishlist"><i
