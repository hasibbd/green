...
function Status(id) {
    ...
    let  my_url = base + "/slider-status/" + id;
    $.ajax({
        type: 'get',
        url: my_url,
        success: (data) => {
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                let  my_url = base + "/slider-delete/" + id;
                $.ajax({
                    type: 'delete',
                    url: my_url,
                    success: (data) => {
...
function Show(id) {
    ...
    let  my_url = base + "/slider-show/" + id;
    $.ajax({
        type: 'get',
        url: my_url,
        success: (data) => {
            ...
            $('#previewImg').attr('src', '/storage/slider/'+data.data.photo);
