    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel"><span id="mdl_ttl"></span> Slider</h5>
            ...
            <form id="form_submit" enctype="multipart/form-data">
                <div class="modal-body">
                    <img id="previewImg" class="img-thumbnail" src="{{asset('/storage/slider/default.png')}}" alt="photo" style="width: 150px; height: 100px">
